...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<SvgGenImage> get values => [delete, edit, location, notification, time];
}
...
class $AssetsVectorsGen {
  ...
  /// File path: assets/vectors/location.vec
  SvgGenImage get location => const SvgGenImage.vec('assets/vectors/location.vec');

  /// File path: assets/vectors/notification.vec
  SvgGenImage get notification => const SvgGenImage.vec('assets/vectors/notification.vec');

  /// File path: assets/vectors/time.vec
  SvgGenImage get time => const SvgGenImage.vec('assets/vectors/time.vec');

  /// List of all assets
  List<SvgGenImage> get values => [location, notification, time];
}
